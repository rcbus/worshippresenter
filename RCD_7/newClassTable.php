...
class newTable extends generic {
	...
	public function line($class="",$width=false,$valign=false){
		...
		$this->linesHtml[$id]['nivel'] = $this->nivelInterno++;
		$id = count($this->linesHtml);
		$this->linesHtml[$id]['html'] = "<td id=\"CL".$this->name.$idL."\" name=\"CL".$this->name.$idL."\" class=\"".$class."\"".$width.($valign ? " valign=\"top\"" : " ").">";
		$this->linesHtml[$id]['nivel'] = $this->nivelInterno++;
